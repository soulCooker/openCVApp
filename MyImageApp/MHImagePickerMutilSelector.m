...
-(void)navigationController:(UINavigationController *)navigationController willShowViewController:(UIViewController *)viewController animated:(BOOL)animated
{
    if (navigationController.viewControllers.count>=2) {
        ...
        NSInteger width = viewController.view.frame.size.width;
        NSInteger height = viewController.view.frame.size.height;
        
        [[viewController.view.subviews objectAtIndex:0] setFrame:CGRectMake(0, 0, width, height-131)];
        
        selectedPan=[[UIView alloc] initWithFrame:CGRectMake(0, height-131, width, 131)];
        selectedPan.backgroundColor = [UIColor blackColor];
        ...
        tbv=[[UITableView alloc] initWithFrame:CGRectMake(0, 50, 90, width) style:UITableViewStylePlain];
...
-(UITableViewCell*)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (cell==nil) {
        ...
        [imv.layer setBorderColor:[UIColor redColor].CGColor];
        ...
        [btn_delete setImage:[UIImage imageNamed:@"btn_delete"] forState:UIControlStateNormal];
